...
type FibonacciServiceClient interface {
	GetFibonacciSequence(ctx context.Context, in *GetFibonacciSequenceRequest, opts ...grpc.CallOption) (*GetFibonacciSequenceResponse, error)
}
...
func (c *fibonacciServiceClient) GetFibonacciSequence(ctx context.Context, in *GetFibonacciSequenceRequest, opts ...grpc.CallOption) (*GetFibonacciSequenceResponse, error) {
	out := new(GetFibonacciSequenceResponse)
	err := c.cc.Invoke(ctx, "/api.FibonacciService/GetFibonacciSequence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServiceServer interface {
	GetFibonacciSequence(context.Context, *GetFibonacciSequenceRequest) (*GetFibonacciSequenceResponse, error)
...
func (UnimplementedFibonacciServiceServer) GetFibonacciSequence(context.Context, *GetFibonacciSequenceRequest) (*GetFibonacciSequenceResponse, error) {
...
func _FibonacciService_GetFibonacciSequence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFibonacciSequenceRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.FibonacciService/GetFibonacciSequence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServiceServer).GetFibonacciSequence(ctx, req.(*GetFibonacciSequenceRequest))
	}
